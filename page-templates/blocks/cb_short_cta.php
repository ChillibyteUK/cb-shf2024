...
<section class="short_cta <?=$invert?> <?=$class?>">
    <div class="container-xl short_cta__inner p-5">
        ...
        <div class="text-center text-md-start">
            <input type="text" name="postcode" id="postcode_<?=$id?>" placeholder="Enter your postcode" autocomplete="false"><button class="button button-sm" onclick="redirectToForm('postcode_<?=$id?>')">Get Free Cash Offer</button>
        </div>
    </div>
</section>
